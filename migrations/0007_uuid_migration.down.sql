...
ALTER TABLE teams MODIFY created_by BIGINT NOT NULL;

ALTER TABLE team_members MODIFY id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE team_members MODIFY user_id BIGINT NOT NULL;
ALTER TABLE team_members MODIFY team_id BIGINT NOT NULL;

ALTER TABLE tasks MODIFY id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE tasks MODIFY assignee_id BIGINT;
ALTER TABLE tasks MODIFY team_id BIGINT NOT NULL;
ALTER TABLE tasks MODIFY created_by BIGINT NOT NULL;

ALTER TABLE task_history MODIFY id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE task_history MODIFY task_id BIGINT NOT NULL;
ALTER TABLE task_history MODIFY changed_by BIGINT NOT NULL;

ALTER TABLE task_comments MODIFY id BIGINT NOT NULL AUTO_INCREMENT;
ALTER TABLE task_comments MODIFY task_id BIGINT NOT NULL;
ALTER TABLE task_comments MODIFY user_id BIGINT NOT NULL;
